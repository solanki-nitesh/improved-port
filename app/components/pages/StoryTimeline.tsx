...
const timelineEvents: TimelineEvent[] = [
  {
    ...
    title: "Project Lead",
    description:
      "Started my 2026 journey as Project Lead, driving delivery and technical direction across projects.",
  },
  {
    period: "2025",
                ...
                >
                  <div
                    className={`flex items-center gap-6 ${
                      isEven ? "flex-row" : "flex-row-reverse md:flex-row-reverse"
                    }`}
                  >
                    {/* Year box - blue/purple gradient */}
