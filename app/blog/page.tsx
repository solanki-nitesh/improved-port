...
export const metadata: Metadata = {
  title: "Blog | Nitesh Solanki",
  metadataBase: new URL("https://niteshsolanki.com/blog"),
  description: "Read latest stories from Nitesh Solanki's Blog",
  openGraph: {
    title: "Blog | Nitesh Solanki",
    url: "https://niteshsolanki.com/blog",
    description: "Read latest stories from Nitesh Solanki's Blog",
    images:
