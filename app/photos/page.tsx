...
export const metadata: Metadata = {
  title: "Photos | Nitesh Solanki",
  metadataBase: new URL("https://niteshsolanki.com/photos"),
  description: "Explore photos taken by Nitesh Solanki",
  openGraph: {
    title: "Photos | Nitesh Solanki",
    url: "https://niteshsolanki.com/photos",
    description: "Explore photos taken by Nitesh Solanki",
    images:
